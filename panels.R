    ...
    mainPanel(
      ...
      tabsetPanel(
        tabPanel("Summary Page",
                 ...
                 fluidRow(column(width = 12, div(class = "header-text", "Top 3 Categories:"))),
                 fluidRow(
                 ...
                 fluidRow(column(width = 12, div(class = "header-text", "Summary Analysis:"))),
                 fluidRow(
...
generate_sidebar_layout <- function(id_prefix) {
  sidebarLayout(
    generate_sidebar_panel(id_prefix),
    generate_main_panel(id_prefix)
  )
}
